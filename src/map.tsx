...
const MapHeader = () => (
  <div className="flex items-center gap-3 mb-4 justify-center">
    <span className="inline-flex items-center justify-center p-3 rounded-full shadow-lg" style={{ background: 'var(--icon-bg)' }}>
...
const MapContainer = ({ searchQuery }: { searchQuery: string }) => (
