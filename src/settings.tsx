      ...
      <div className="relative z-10 max-w-md mx-auto w-full flex flex-col gap-8 pt-10 pb-4">
        <div className="flex flex-col items-center gap-4">
          <div className="rounded-full p-3 shadow-lg"
            style={{ background: 'var(--fetch-btn)' }}>
        ...
        <div className="rounded-2xl shadow-2xl px-6 py-6 flex flex-col gap-4 border-2"
          ...
          <div className="flex flex-col gap-2 mt-2">
            ...
            <div className="flex gap-2 w-full">
              ...
              />
              <Button onClick={handleFetch} className="font-semibold shadow-md rounded-xl px-6 py-2"
                style={{ background: 'var(--fetch-btn)', color: 'var(--card-text)' }}>Fetch</Button>
            </div>
          </div>
        </div>
        ...
        {/* Theme Section */}
        <div className="rounded-2xl border shadow-2xl px-6 py-6 flex flex-col gap-4"
          style={{
            background: 'var(--card-bg)',
          ...
          <div className="flex gap-3">
            <button
              ...
              style={{
                background: theme === "dark-blue" ? 'var(--theme-btn-active)' : 'var(--theme-btn)',
                color: theme === "dark-blue" ? '#fff' : 'var(--theme-text)',
                borderColor: 'var(--card-border)'
              }}
            ...
            <button
              className="px-4 py-2 rounded-lg font-semibold shadow transition-all duration-200 border-2 text-sm"
              style={{
                background: theme === "white" ? 'var(--theme-btn-active)' : 'var(--theme-btn)',
                color: theme === "white" ? 'var(--card-text)' : 'var(--theme-text)',
                borderColor: 'var(--card-border)'
              }}
            ...
            <button
              className="px-4 py-2 rounded-lg font-semibold shadow transition-all duration-200 border-2 text-sm"
              style={{
                background: theme === "dark-red" ? 'var(--theme-btn-active)' : 'var(--theme-btn)',
                color: theme === "dark-red" ? '#fff' : 'var(--theme-text)',
                borderColor: 'var(--card-border)'
              }}
